...
const Login = () => {
  return (
    <div className="w-full h-full flex items-start bg-white">
      <div className="w-1/2 h-screen bg-[#533896] text-center overflow-hidden">
        <Image
          src={ImgLogin}
          alt="login"
          className="object-cover w-96 mx-auto mt-44"
        />
        <h1 className="text-3xl mt-6 font-bold text-white mx-72">
          Interaksi Sesama Mahasiswa Amikom
        </h1>
        <p className="text-white text-lg font-extralight mx-[17.5rem] mt-4">
      ...
      <div className="flex flex-col items-center justify-center py-32 mx-auto">
        <div className="w-full">
          <div>
            ...
            <div className="text-center mt-14">
              <h1 className="font-semibold text-[2rem]">Masuk ke Akun anda</h1>
        ...
        <form action="" className="mt-10 flex flex-col space-y-[0.8rem]">
