  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen">
        <Image src="/logo.png" alt="logo" width={200} height={200} className="mb-4"></Image>
              ...
              <div className="flex justify-between gap-2">
                {password.map((digit, i) => (
                  <div key={i} className="w-14 h-14 relative rounded-lg ">
                    <label
                      htmlFor={`pin_${i}`}
                      className={`absolute flex justify-center rounded-lg border items-center text-2xl top-0 left-0 w-full h-full cursor-pointer ${activeInput === i
                        ? "bg-gray-500 border-primary-main"
